...
export default class Number extends React.Component<BunsenComponentProps, InputState> {
    public displayName: string = 'NumberInputDemoComponent';
     ...
     * @param {Number} value - the new value from the editor
     */
    private _onModelChange(value: any): void {
        try {
            const model: any = JSON.parse(value);
            this.setState({model});
        } catch (e) {
            console.log(e);
        }
